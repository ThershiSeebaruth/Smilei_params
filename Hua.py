...
v0 = 1.0e7 #velocity in cm/s --> 300 km/s 
v0_c = v0/c

## ------- PISTON PLASMA -------

TeP_eV = 15 # temperature of electrons in eV
TiP_eV = 15 # temperature of ions in eV 
...
num_patches = 2**10 #power of 2 (prioritize large number of patches?)
...
Species(
    ...
    mass = 1.0,
    charge =-1.0,
    number_density = trapezoidal(neP_n0, xvacuum=2*dx, xplateau=6100*dx, xslope1=30*dx, xslope2=2*dx  ),
...
Species(
    ...
    mass = miP,
    charge = ZP,
    number_density = trapezoidal(niP_n0, xvacuum=2*dx, xplateau=6100*dx, xslope1=30*dx, xslope2=2*dx  ),
    mean_velocity = [-v0_c, 0., 0.], #need to change the values of the velocity 1
    temperature = [TeP_mec2],
    boundary_conditions = [[ "reflective", "remove"],
    ],
